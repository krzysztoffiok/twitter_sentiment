...
# to reproduce all training experiments on semeval:
bash ./grid_train_semeval

# to reproduce all training experiments on usnavy:
bash ./grid_train_usnavy
...
mbs = test_run[-2:]
mname = test_run[:-2]
results_path = "./flair_training_time_results/{}/{}".format(dataset, test_run)
