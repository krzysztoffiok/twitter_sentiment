...
def ML_classification(allFeatures, train_ml, test_ml, df_ml, classification_model, language_model, fold_number):
    """
...
def term_frequency(train_ml, dfliwc, df, allFeatures):
    foldTFfeatures = {}
    allWords = []
